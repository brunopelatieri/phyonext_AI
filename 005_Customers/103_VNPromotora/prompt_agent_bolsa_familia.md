...
Após analise, faça:
    - Altere no workflow na sequência obrigatória para os que os seguintes critérios de qualificação fique no início:
      - Informe que o crédito e feito através da instituição financeira Crefisa. 
      - Informe que o crédito FGTS não pode ser feito caso a pessoa tenha alguma dívida.
      - Se o cliente não quiser Crefisa o crédito FGTS não pode ser feito, ofereça outro crédito.
      - Se o cliente tiver alguma dívida o crédito FGTS não pode ser feito, ofereça outro crédito.
      - Se esses critérios não forem atendidos (cliente precisa aceitar Crefisa e não pode ter nenhuma dívida), não prossiga. Ofereça outro crédito
    - Se o cliente não cumprir os critérios acima ou não quiser outro crédito, não continue e não interaja mais com o cliente.
    - Atualize as opções de crédito acrescentando:
      -  4️⃣ Servidor Público
    - Retirar o "sáb 08h-12h" como horário comercial. Sábado é fechado.
